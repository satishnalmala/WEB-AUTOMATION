...
public class Details_Job_Approval_Details {
	...
	@Test
	public void Approval_Details() throws InterruptedException
	{
		...
		djp.searchJob();
		Thread.sleep(2000);
		driver.findElement(djp.ApprovalDetailTab).click();
		cf.myWait(5);
		Thread.sleep(2000);
		driver.findElement(djp.ApprovalsRequiredtextarea).sendKeys("Testing Data for Approval details");
		

		driver.findElement(djp.ApprovalRequiredsave).click();
