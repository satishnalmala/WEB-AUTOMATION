...
public class Details_Job_Salvage {
	...
	@Test
	public void Salvage() throws InterruptedException
	{
		...
		djp.searchJob();
		Thread.sleep(2000);
		driver.findElement(djp.SalvageTab).click();
		cf.myWait(5);
		Thread.sleep(2000);
		driver.findElement(djp.Condition_of_Salvagetextarea).sendKeys("Testing Data for Salvage Condition");
		

		driver.findElement(djp.Salvagesave).click();
